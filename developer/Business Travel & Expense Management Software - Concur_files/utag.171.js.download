//tealium universal tag - utag.171 ut4.0.201707251516, Copyright 2017 Tealium.com Inc. All Rights Reserved.
...
try{(function(id,loader,u){u=utag.o[loader].sender[id]={};u.ev={'view':1};u.initialized=false;u.map={};u.extend=[];u.send=function(a,b){if(u.ev[a]||typeof u.ev.all!="undefined"){var c,d,e,f;u.data={"pid":"l5jmo","base_url":"//platform.twitter.com/oct.js"}
...
utag.o[loader].loader.LOAD(id);})('171','concur.concur');}catch(e){}
